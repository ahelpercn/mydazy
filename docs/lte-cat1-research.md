...
**公司背景**：成立于 2021 年 4 月，深圳，专注于蜂窝物联网 SoC 及移动通信智能芯片，官网：aicxtek.com。

| 芯片型号 | 系列 | 制程 | 标准 | 核心特性 |
|---------|------|------|------|---------|
| **GX31X（GX316）** | GX31X | **22nm** | LTE Cat.1bis | 五合一（Modem+RF+pSRAM 4MB+Flash 4MB+PMIC），**安谋 STAR-MC1**（ARMv8-M，~M4级），PSM **3µA**，XIP 扩展 |
| **GX30X（GX318）** | GX30x | **22nm** | LTE Cat.1bis | 异构多核，**500MHz 独立应用核**，MCU 独立模式，**CAN bus**，关机 **<0.03µA（30nA）**，RF 450–2700MHz，2024年4月量产 |

**CPU 核心说明**：GX31X 使用 **安谋科技（Arm China）STAR-MC1** 处理器，这是 Arm 中国团队自研的 ARMv8-M 架构核心（带 TrustZone），性能约 4.02 CoreMark/MHz，比 Cortex-M3 快约 20%，与 M3/M4 C 代码二进制兼容，支持 Keil MDK/IAR/GCC 工具链。

**GX30X 设计赢家**：中移物联（中国移动 IoT 子公司）基于 GX30X（GX318）推出 **ML307G 系列** Cat.1 模组（17.7×15.8mm，LCC+LGA 封装），采用全国产化芯片及外围器件，支持 OpenCPU+XIP 开发，适用于智能支付、安防、定位追踪、智慧表计、智能穿戴等场景。

**GX31X 适用场景**：功能手机、智能穿戴手表、学生卡、泛物联网通信模组、车载追踪器、智慧安防、智慧支付。

**GX30X 新增场景**：车载（CAN bus），工业控制（MCU 独立模式），全球出海项目（450–2700MHz 全球频段）。

> ⚠️ 风险提示：2024年10月曝出薪资减半传闻，公司否认但电话无法接通。建议大批量采购前评估资金健康状况。联系方式：sales@aicxtek.com

---

#### 2.1.6 信翼科技（XINYISEMI）
